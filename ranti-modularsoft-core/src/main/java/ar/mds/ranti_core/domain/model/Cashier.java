...
public class Cashier {
    ...
    public void addCashMovement(CashMovement cashMovement) {
        this.assertIsOpened();
        if (cashMovement.getType() == DEPOSIT) {
            this.deposit(cashMovement.getCash(), cashMovement.getDescription());
        } else {
            this.withdrawal(cashMovement.getCash(), cashMovement.getDescription());
        }
    }
