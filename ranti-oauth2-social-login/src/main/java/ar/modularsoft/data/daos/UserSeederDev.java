...
public class UserSeederDev {
    ...
    private UserRepositoryRanti userRepository;

    @Autowired
    public UserSeederDev(UserRepositoryRanti userRepository, DatabaseStarting databaseStarting) {
        this.userRepository = userRepository;
        this.databaseStarting = databaseStarting;
       // this.deleteAllAndInitializeAndSeedDataBase();
        System.err.println(new BCryptPasswordEncoder().encode("12345678"));
        LogManager.getLogger(new BCryptPasswordEncoder().encode("12345678"));
    }
