...
public class CompanyService {
    ...
    public Page<Company> getCompanyByNameContains(String companyName, Pageable page) {
        return this.companyRepository.findByCompanyNameContainsIgnoreCase(companyName,page);
    }
